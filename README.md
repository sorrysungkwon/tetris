...
| ~~v1.0.6~~ ✅ | **Settings, Accessibility & Polish**: Ghost piece on/off toggle, lock-delay tuning in pause menu, keyboard shortcut hints on How To Play overlay. Privacy Policy + Terms of Service pages (AdSense-ready). Automatic performance mode — monitors FPS and disables glow/particles/nebulae below 30 FPS. |
