...
| ~~Pre-v1.2~~ ✅ | **UI Polish**: Gestalt visual grouping of overlays (game over stats card, daily challenge briefing cards). Replaced inline styles with premium CSS classes and smooth CSS transitions. Wider dialog overlays (width 340px) for better spacing. |

### 🔮 Planned

| Version | Theme | Features | DAU Goal |
|---|---|---|---:|
| ~~Pre-v1.2~~ ✅ | **UI Polish** | Visual grouping of related overlays (game over stats card, daily challenge briefing). Replaced inline styles with premium CSS classes, hover transitions. Wider overlays (340px) for better layout breathing space. | — |
